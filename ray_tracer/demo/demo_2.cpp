...
void demo_2::set_world() {
	...
	s->apply_transformation(transformation_rotate(point3D(0, 0, 0), vector3D(0, 0, 1), PI));
	s->apply_transformation(transformation_rotate(point3D(0, 0, 0), vector3D(-10, 0, 0), -PI / 18));
